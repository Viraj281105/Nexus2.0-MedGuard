      ...
      >
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight">
            MedGuard <span className="text-[var(--color-primary)]">AI</span>
          </h1>
        </div>
        ...
        <div className="glass-panel rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-slate-400 text-center mb-6 text-sm">
            Sign in to manage your insurance appeals
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white focus:outline-none focus:border-[var(--color-primary)] transition-colors"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl font-bold text-lg bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] text-white transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(16,185,129,0.3)] disabled:opacity-50"
            >
